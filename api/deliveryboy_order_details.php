...
if (isset($_REQUEST["order_id"])) {
    $query = mysqli_query($conn, "SELECT fb.id,fb.total_price , fb.created_at , fb.address , fb.payment , fb.lat , fb.long , count(fd.order_id) as count , fd.ItemId , fu.fullname , fu.phone_no  from 

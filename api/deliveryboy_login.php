...
if (isset($_REQUEST["email"]) && isset($_REQUEST["password"])) {
    ...
    if ($user_name && $user_pass) {
        ...
        $sql = mysqli_query($conn,"SELECT id, name, phone, email, password, vehicle_no, vehicle_type FROM fooddelivery_delivery_boy WHERE email='" . strip_tags($_REQUEST["email"]) . "' and password='" . strip_tags($_REQUEST["password"]) . "'");

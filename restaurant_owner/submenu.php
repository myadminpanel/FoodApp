            ...
            <div class="col-md-12">
                <div class="result-container">
                    ...
                    <div class="btn-group m-l-10 m-b-20">
                        <a href="#addmenu"  data-toggle="modal" class="btn btn-white btn-white-without-border">Add New Sub Menu</a>
                    </div>
                    <?php
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" method="post" action="" name="demo-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text"  name="desc" maxlength="50" onchange="desclength(this.value)" placeholder="Short One Line Description " data-parsley-required="true" />

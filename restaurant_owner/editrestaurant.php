...
if ($urlid == '0') {
    ...
    $res=$user->getrestaurantdetail($urlid);
}
...
if(isset($_POST['addrestaurant']))
{
    if(isset($_FILES['file']['name']))
    {
        ...
        if($width == 800 && $height == 500)
        {
            ...
            if(move_uploaded_file($tmp_file,$file_path))
            {
                ...
                extract($_REQUEST);
                $user->addrestaurantdetail($name, $address,$desc,$email,$phone,$website,$del_time,$open_time,$close_time,$category,$city,$location,$latitude,$longitude,$imagename,$currency,$dcharge);

                $gt_id = mysqli_query($conn,"SELECT id from fooddelivery_restaurant order by id desc limit 1");
                $id = mysqli_fetch_array($gt_id);
                $last_id = $id['id'];
                $pdate = mysqli_query($conn,"UPDATE `fooddelivery_res_owner` SET `res_id`='".$last_id."' WHERE id='".$uid."'");
                if($user)
                {
    ...
    {
        ?><script>document.getElementById("error").innerHTML="Error : Please Select Restaurant Image";</script><?php
    }
}
if(isset($_POST['editrestaurant']))
{
    if(isset($_FILES['file']['name']) && $_FILES['file']['name'] != "")
    {
        ...
        if($width == 800 && $height == 500)
        {
            ...
            {
                extract($_REQUEST);
                $user->editrestaurantdetail($urlid,$name, $address,$desc,$email,$phone,$website,$del_time,$open_time,$close_time,$category,$city,$location,$latitude,$longitude,$imagename,$currency,$dcharge);
                if($user)
                {
                    ?><script>window.location='dashboard.php';</script><?php
                }
    ...
    {
        extract($_REQUEST);
                $user->editrestaurantdetail($urlid,$name,$address,$desc,$email,$phone,$website,$del_time,$open_time,$close_time,$category,$city,$location,$latitude,$longitude,"none",$currency,$dcharge);
        if($user)
        {
            ?><script>window.location='dashboard.php';</script><?php
        }
...
<head>
    <meta charset="utf-8" />
    <title>Food Delivery System | Edit Restaurant</title>
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <h1 class="page-header">Edit Store <small>Edit Store Detail Form</small></h1>
        <div class="row">
            <?php
            if ($urlid == '0') {
            ?>
                        ...
                        <div class="panel-body panel-form">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" value="<?php echo $res->username; ?>"  name="name" placeholder="Restaurant Name" readonly="" style="cursor: no-drop;"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="email">Address * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <textarea class="form-control"  name="address" placeholder="Address" data-parsley-required="true" ></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="email">Restaurant Desc * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <textarea class="form-control"  name="desc"  placeholder="Descriptions" data-parsley-required="true" ></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="fullname">Email * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="email" name="email" value="<?php echo $res->email; ?>" placeholder="Email" readonly="" style="cursor: no-drop;"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="message">Phone No :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text"  name="phone" value="<?php echo $res->phone; ?>" placeholder="Phone Number" readonly="" style="cursor: no-drop;"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="website">Website :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="url"  name="website" data-parsley-type="url" placeholder="url" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="website">Delivery Time :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="number" name="del_time" placeholder="Delivery Time For Ex : 30" required/>
                                    <div style="color: red;">Time is in Min.</div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="website">Currency</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text"  name="currency" value="<?php echo $get_currency['currency']; ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group bootstrap-timepicker">
                                        <input id="timepicker" type="text" class="form-control" name="open_time" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group bootstrap-timepicker">
                                        <input id="timepicker1" type="text" class="form-control" name="close_time" />
                                        <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-2">
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="dcharge" placeholder="Case On Delivery" required data-parsley-required="true" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="us2-address" name="location" placeholder="Search location" required data-parsley-required="true" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="us2-lat" name="latitude"  data-type="alphanum" placeholder="Latitude"  data-parsley-required="true" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4">Longitude* :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="us2-lon" name="longitude"  data-type="alphanum" placeholder="Longitude"  data-parsley-required="true" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <button type="submit" name="addrestaurant" id="addresto" class="btn btn-primary">Add Restaurant Detail</button>                                   
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="fullname">Restaurant Name * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" value="<?php echo $res->name; ?>"  name="name" placeholder="Restaurant Name" readonly="" style="cursor: no-drop;"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="email">Address * :</label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="fullname">Email * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="email"  value="<?php echo $res->email; ?>" name="email" placeholder="Email" readonly="" style="cursor: no-drop;"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="message">Phone No :</label>
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-2">
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4">Search Location* :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" value="<?php echo $res->location; ?>" 
                                    id="us2-address" name="location" placeholder="Search location" required data-parsley-required="true" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-6 col-sm-12">

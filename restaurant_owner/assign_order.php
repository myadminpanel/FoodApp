...
if($update)
{
    echo "<script>alert('Order assigned ".json_encode($sendresult)."');
    window.location='dashboard.php';</script>";
} else {
    echo "<script>'alert('Please try again ".json_encode($sendresult)."')';
    window.location='dashboard.php';</script>";
}

...
$update=mysqli_query($conn,"update fooddelivery_bookorder set status=4,delivered_date_time='$date',delivered_status='active' WHERE id='$order_id'");
if($update )
{
    echo 1;
} else {

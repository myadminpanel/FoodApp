...
// }
if(isset($_REQUEST['addrestaurant']))
{
    if(isset($_FILES['file']['name']))
    {
        ...
        if($width <= 800 && $height <= 500)
        {
            ...
            if(move_uploaded_file($tmp_file,$file_path))
            {
                ...
                $pdate = mysqli_query($conn,"INSERT INTO `fooddelivery_res_owner`(`username`,`password`,`phone`,`email`,`role`,`res_id`,`timestamp`) VALUES ('".$_POST['name']."','".$_POST['password']."','".$_POST['phone']."','".$_POST['email']."','2','".$last_id."','".$timestamp."')");
...
<head>
    ...
    <meta content="" name="Food Delivery System Every thing food avilable in this app to visit now my apps and web site." />
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text"  name="name" placeholder="Restaurant Name" data-parsley-required="true" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="email"  name="email" placeholder="Email" data-parsley-required="true" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="number"  name="del_time" placeholder="Delivery Time For Ex : 45 Min" required />
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-2">
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="us2-lat" name="latitude"  data-type="alphanum" placeholder="Latitude"  data-parsley-required="true" required="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4">Longitude* :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="us2-lon" name="longitude"  data-type="alphanum" placeholder="Longitude"  data-parsley-required="true" required="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4">Selecte Restaurant Image</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="file" name="file" id="uploadImage" onchange="PreviewImage();"  required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <button type="submit" name="addrestaurant" id="addresto" class="btn btn-primary">Add Restaurant</button>
                                </div>
                            </div>
                        </div>
                    </div>

...
// }
if(isset($_REQUEST['addresowner']))
{
    extract($_REQUEST);
    $checkadmin=$user->checkresowneraccess($email,$name);
    if($checkadmin)
    {
        ?><script>
        alert("Error : Admin Already Exist");
        document.getElementById("error").innerHTML="Error : Restaurant Already Exist";</script><?php
    }
    else
    {
        if($password == $confirmpwd)
        {
            $user->addnewresowneraccess($name,$password,$time,$mobile,$email);
            if($user)
            {
...
<head>
    <meta charset="utf-8" />
    <title>Food Delivery System | Restaurant Access</title>
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        <h1 class="page-header">Add Restaurant Owner <small>Add New Restaurant Owner Detail Form</small></h1>
        <div class="row">
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text"  name="name" placeholder="User Name" data-parsley-required="true" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="fullname">Phone Number * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text"  name="mobile" placeholder="Mobile Number" data-parsley-required="true" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <button type="submit" name="addresowner" id="addcat" class="btn btn-primary">Add Restaurant Owner</button>
                                </div>
                            </div>
                        </div>
                    </div>

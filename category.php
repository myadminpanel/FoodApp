...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        <ol class="breadcrumb pull-right">
            <li><a href="dashboard.php">Home</a> / Category</li>
        </ol>
        <h1 class="page-header">Search Category </small></h1>
        <div class="row">
            <div class="col-md-12">
                <div class="result-container">
                    ...
                    <div class="btn-group m-l-10 m-b-20">
                        ...
                        <a href="addnewcategory.php"  class="btn btn-white btn-white-without-border">Add New Category</a>
                    ...
                    {
                        $search=$_GET['search'];
                        $qutotal= $user->getcategoryall($search,"searchtotal","none","none");
                        $query = $user->getcategoryall($search,"search",$start,$per_page);
                    }
                    else
                    {
                        $query = $user->getcategoryall("none","none",$start,$per_page);
                        $qutotal= $user->getcategoryall("none","total","none","none");
                    } ?>
                                ...
                                <li>
                                    <div class="col-md-2">
                                        <div class="result-image" style="width: 100px;height: 100px;font-size: 65px;text-align: center;background-color: #2D353C;color: white;">
                                           <!-- <img src="Uploads/restaurant/<?php /*echo $val['image']; */?>" alt=""/>-->
                                           <!-- <div style="height: 100px;width:100px;background-color: #00acac;"></div>-->
                                            <?php
                                                $mname=$val['cname'];
                                    ...
                                    <div class="col-md-6">
                                        <div class="result-info" >
                                            <h1 class="title" style="line-height: 50px;" ><a href="subcategory.php?alexe0sdsc=<?php echo $enc_str; ?>"><?php echo $val['cname']; ?></a></h1>
                                            <div>Created At : <font color="#242A30"> </font><?php echo date("d-M-Y H:s:ia", $val['created_at']); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                         <a href="subcategory.php?alexe0sdsc=<?php echo $enc_str; ?>" class=" email-time btn btn-success" style="color: white;"><i class="fa fa-plus"></i> Add Subcategory</a>

                                         <?php $Constant = button; 
                                            if ($Constant == "Active") { ?>
                                           
                                            <a href="editcategory.php?<?php echo $enc_str; ?>" class="btn btn-inverse"><i class="fa fa-edit"></i> Edit</a>

                                            <a href="#" onclick="deletecategory('<?php echo $enc_str; ?>')" class="btn btn-danger"><i class="fa fa-remove"></i> Delete</a>
                                            <?php } else { ?>
        ...
        if(x) {
            ...
            ({
                ...
                success: function (data)
                {
                    if (data)
                    {
                        window.location='category.php<?php echo $_SERVER['QUERY_STRING']; ?>';
                    }
                    else
                    {

   ...
   /* if(isset($_FILES['file']['name']) && $_FILES['file']['name'] != "")
    {
        ...
        if($width == 800 && $height == 500)
        {
            ...
            {
                extract($_REQUEST);
                $user->editcategorydetail($id,$cname,$imagename);
                if($user)
                {
...
$search="spain";
        extract($_REQUEST);
        $user->editcategorydetail($id,$cname,0);
        if($user)
        {
            ?><script>window.location='category.php';</script><?php
        }
...
<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
    ...
    <div id="content" class="content">
        ...
        <h1 class="page-header">Add Category <small>Add Category Detail Form</small></h1>
        <div class="row " >
                           ...
                           <!-- <div class="form-group">
                            ...
                            <div class="form-group" id="images">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <img id="uploadPreview" src="uploads/restaurant/<?php /*echo $res->image; */?>" style="width: 150px; height: 100px;" />
                                </div>
                            </div>-->
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"></label>
                                <div class="col-md-6 col-sm-6">
                                    <a href="category.php" class="btn btn-sm btn-white" data-dismiss="modal">Cancel</a>
                                    <button type="submit" name="editcategory" id="addcat" class="btn btn-primary">Update Category Detail</button>
                                </div>
                            </div>
